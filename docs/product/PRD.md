...
- **Still being built:** deeper *Melee* tech (on-beat parry, cancel/gatling windows, wavedash-like movement), multi-enemy/boss-phase parity in the arena, party-member switching, and the fuller HLD art upgrade (bespoke colossal enemy art, additive glow/bloom).
