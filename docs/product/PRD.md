...
| Status | Draft v4.1 — vertical slice with in-engine art, full ability kits, a visual campaign map, and a verified-green (Chromium) CI/deploy pipeline; pending stakeholder sign-off |
| Owner | Amir Bukhari |
