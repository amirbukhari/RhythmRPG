...
assets/
  sprites/      hero sprites (placeholder-quality art, rendered in-engine in battle and
                as the walking overworld player)
  tilemaps/     overworld tileset + Tiled-JSON map (generated by tools/overworld/, committed)
...
tools/
  ...
  overworld/    deterministic generator for the committed overworld tileset/tilemap assets
```
